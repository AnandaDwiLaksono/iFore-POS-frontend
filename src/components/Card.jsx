              ...
              <div className='p-4 flex w-full items-center'>
                <div className='w-2/3'>
                  ...
                  <span className='text-[#344767] text-xl font-bold dark:text-white'>
                    Rp {(data?.data?.data?.[value]).toLocaleString('id-ID')}
                  </span>
                  {percentage !== undefined && (
                    <span className={data?.data?.data?.[percentage].startsWith('-') ? 'text-[#ea0606] text-sm font-bold ml-1' : 'text-[#82d616] text-sm font-bold ml-1'}>
